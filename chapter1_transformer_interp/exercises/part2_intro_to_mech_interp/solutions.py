...
from arena3.chapter1_transformer_interp.exercises.part1_transformer_from_scratch.solutions import (
    get_log_probs,
)
from arena3.chapter1_transformer_interp.exercises.part2_intro_to_mech_interp import (
    tests,
)
